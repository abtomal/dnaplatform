...
var Collection = function () {
    ...
    var handlePurchase = function (tokenId, price) {
        ...
        try {
            writeContract({
                ...
                account: address // Cast the address to the expected type
            });
        }
        catch (error) {
    ...
    var fetchNFTsForSale = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return (_jsxs("div", { className: "my-collection", children: [_jsxs("div", { className: "collection-header", children: [_jsx("h1", { children: "NFT Collection" }), _jsx("p", { children: "Discover and purchase unique scientific NFTs" })] }), loading ? (_jsxs("div", { className: "loading", children: [_jsx("div", { className: "loading-spinner" }), _jsx("p", { children: "Loading NFTs..." })] })) : nfts.length === 0 ? (_jsxs("div", { className: "empty-collection", children: [_jsx("h2", { children: "No NFTs Available" }), _jsx("p", { children: "There are currently no NFTs available for purchase." })] })) : (_jsxs("div", { className: "nft-grid", children: [_jsx("h2", { children: "Available Scientific NFTs" }), _jsx("div", { className: "grid", children: nfts.map(function (nft) { return (_jsxs("div", { className: "nft-card", children: [_jsx("div", { className: "nft-image-container", children: nft.image ? (_jsx("img", { src: nft.image.startsWith('ipfs://')
